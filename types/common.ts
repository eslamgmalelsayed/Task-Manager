...
export interface CrudOperations<T, CreateData = Partial<T>, UpdateData = Partial<T>> {
    ...
    list: (params?: FilterParams & SortParams & PaginationParams) => Promise<PaginatedResponse<T>>;
}
...
export const SUPABASE_SECRET_KEY = process.env.NEXT_PUBLIC_SUPABASE_SECRET_KEY || "";
